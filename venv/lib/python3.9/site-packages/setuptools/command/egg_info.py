...
class FileList(_FileList):
    ...
    def process_template_line(self, line) -> None:
        ...
        action_map: dict[str, Callable] = {
            ...
            "recursive-include": functools.partial(self.recursive_include, dir,),
            "recursive-exclude": functools.partial(self.recursive_exclude, dir,),
            "graft": self.graft,
            "prune": self.prune,
        }
        log_map = {
        ...
        self.debug_print(
            " ".join([action] + ([dir] if action_is_recursive else []) + patterns,)
        )
