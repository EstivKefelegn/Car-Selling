...
class editable_wheel(Command):
    ...
    def _select_strategy(
        self, name: str, tag: str, build_lib: StrPath,
    ) -> EditableStrategy:
...
class _LinkTree(_StaticPth):
    ...
    def __init__(
        self, dist: Distribution, name: str, auxiliary_dir: StrPath, build_lib: StrPath,
    ) -> None:
...
def _find_package_roots(
    packages: Iterable[str], package_dir: Mapping[str, str], src_root: StrPath,
) -> dict[str, str]:
