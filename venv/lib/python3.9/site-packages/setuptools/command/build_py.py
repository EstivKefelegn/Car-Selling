...
class build_py(orig.build_py):
    ...
    def find_data_files(self, package, src_dir):
        ...
        patterns = self._get_platform_patterns(
            self.package_data, package, src_dir, extra_patterns=_IMPLICIT_DATA_FILES,
        )
    ...
    def get_output_mapping(self) -> dict[str, str]:
        ...
        mapping = itertools.chain(
            self._get_package_data_output_mapping(), self._get_module_mapping(),
        )
    ...
    def _get_platform_patterns(spec, package, src_dir, extra_patterns=()):
        ...
        raw_patterns = itertools.chain(
            extra_patterns, spec.get("", []), spec.get(package, []),
        )
        return (
