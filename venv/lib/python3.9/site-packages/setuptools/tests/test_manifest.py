...
translate_specs: list[tuple[str, list[str], list[str]]] = [
    ...
    ("foo/**/bar", ["foo/bing/bar", "foo/bing/bang/bar", "foo/bar"], ["foo/abar"],),
    ("foo/**", ["foo/bar/bing.py", "foo/x"], ["/foo/x"],),
    ("**", ["x", "abc/xyz", "@nything"], [],),
    # Character classes
    ("pre[one]post", ["preopost", "prenpost", "preepost"], ["prepost", "preonepost"],),
    (
        "hello[!one]world",
        ["helloxworld", "helloyworld"],
        ["hellooworld", "helloworld", "hellooneworld"],
    ),
    ("[]one].txt", ["o.txt", "].txt", "e.txt"], ["one].txt"],),
    ("foo[!]one]bar", ["fooybar"], ["foo]bar", "fooobar", "fooebar"],),
]
"""
