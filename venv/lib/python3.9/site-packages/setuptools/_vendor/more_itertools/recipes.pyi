...
def all_equal(iterable: Iterable[_T], key: Callable[[_T], _U] | None = ...) -> bool: ...
...
def grouper(
    iterable: Iterable[_T], n: int, incomplete: str = ..., fillvalue: _U = ...,
...
@overload
def first_true(
    iterable: Iterable[_T], default: _U, pred: Callable[[_T], object] | None = ...,
) -> _T | _U: ...
...
def iter_index(
    iterable: Iterable[_T], value: Any, start: int | None = ..., stop: int | None = ...,
) -> Iterator[int]: ...
...
def reshape(matrix: Iterable[Iterable[_T]], cols: int) -> Iterator[tuple[_T, ...]]: ...
