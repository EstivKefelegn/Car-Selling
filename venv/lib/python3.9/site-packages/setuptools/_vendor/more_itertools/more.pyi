...
def collapse(
    iterable: Iterable[Any], base_type: type | None = ..., levels: int | None = ...,
) -> Iterator[Any]: ...
@overload
def side_effect(
...
def split_when(
    iterable: Iterable[_T], pred: Callable[[_T, _T], object], maxsplit: int = ...,
) -> Iterator[list[_T]]: ...
def split_into(
...
@overload
def padded(
    iterable: Iterable[_T], *, n: int | None = ..., next_multiple: bool = ...,
) -> Iterator[_T | None]: ...
@overload
def padded(
    iterable: Iterable[_T],
...
@overload
def stagger(
    iterable: Iterable[_T], offsets: _SizedIterable[int] = ..., longest: bool = ...,
) -> Iterator[tuple[_T | None, ...]]: ...
@overload
def stagger(
    iterable: Iterable[_T],
...
def always_iterable(
    obj: object, base_type: type | tuple[type | tuple[Any, ...], ...] | None = ...,
) -> Iterator[Any]: ...
def adjacent(
...
class numeric_range(Generic[_T, _U], Sequence[_T], Hashable, Reversible[_T]):
    ...
    def __reduce__(self,) -> tuple[Type[numeric_range[_T, _U]], tuple[_T, _T, _U]]: ...
...
@overload
def difference(
    iterable: Iterable[_T], func: Callable[[_T, _T], _U] = ..., *, initial: None = ...,
) -> Iterator[_T | _U]: ...
@overload
def difference(
...
def sample(
    iterable: Iterable[_T], k: int, weights: Iterable[float] | None = ...,
) -> list[_T]: ...
def is_sorted(
    iterable: Iterable[_T],
...
@overload
def minmax(
    iterable_or_value: Iterable[_SupportsLessThanT], *, key: None = None, default: _U,
...
def longest_common_prefix(iterables: Iterable[Iterable[_T]],) -> Iterator[_T]: ...
...
def iter_suppress(
    iterable: Iterable[_T], *exceptions: Type[BaseException],
) -> Iterator[_T]: ...
def filter_map(
    func: Callable[[_T], _V | None], iterable: Iterable[_T],
) -> Iterator[_V]: ...
...
def doublestarmap(
    func: Callable[..., _T], iterable: Iterable[Mapping[str, Any]],
) -> Iterator[_T]: ...
